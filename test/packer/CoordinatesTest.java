...
public class CoordinatesTest {
    ...
    public void testCompanyDistanceTo() {
        ...
        assertEquals(60.0, testCoordinates1.companyDistanceTo(testCoordinates2), ACCEPTABLE_DELTA +1);
        assertEquals(2619.0340, testCoordinates1.companyDistanceTo(testCoordinates3), ACCEPTABLE_DELTA+1);
        assertEquals(2559.4464, testCoordinates2.companyDistanceTo(testCoordinates3), ACCEPTABLE_DELTA+1);
        //adding 1km to the the average of the Euclidean Distance to the customer and the Manhattan Distance to the customer
    }
